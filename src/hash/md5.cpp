...
namespace YanLib::hash {
    md5::md5(const std::vector<unsigned char> &data) {
        hCryptProv = 0;
        hCryptHash = 0;
        data_bytes = data;
        hash_bytes = {};
    ...
    md5::md5(const std::wstring &filename) {
        hCryptProv = 0;
        hCryptHash = 0;
        data_bytes = {};
        hash_bytes = {};
    ...
    std::string md5::format_hex_fast(const std::vector<unsigned char> &data) {
    ...
    std::vector<unsigned char> md5::process() {
        do {
            if (!pre_process()) {
                break;
            }
