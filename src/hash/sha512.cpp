//
// Created by BinRacer <native.lab@outlook.com> on 2025/4/8.
//
...
namespace YanLib::hash {
    ...
    sha512::sha512(const char *filename, helper::CodePage code_page) {
        crypt_prov_handle = 0;
        crypt_hash_handle = 0;
        data_bytes = {};
        hash_bytes = {};
    ...
    bool sha512::pre_process() {
        ...
        do {
            ...
            if (!CryptCreateHash(crypt_prov_handle, CALG_SHA_512, 0, 0,
                                 &crypt_hash_handle)) {
                error_code = GetLastError();
                break;
            }
    ...
    std::wstring sha512::hash_wstring(helper::CodePage code_page) {
