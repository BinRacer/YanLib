...
inline DesiredAccess operator|(DesiredAccess a, DesiredAccess b) {
    return static_cast<DesiredAccess>(
...
inline ShareMode operator|(ShareMode a, ShareMode b) {
    return static_cast<ShareMode>(
        static_cast<uint32_t>(a) | static_cast<uint32_t>(b));
}
#endif
#ifndef CREATIONDISPOSITION
#define CREATIONDISPOSITION
...
inline FlagAndAttr operator|(FlagAndAttr a, FlagAndAttr b) {
    return static_cast<FlagAndAttr>(
        static_cast<uint32_t>(a) | static_cast<uint32_t>(b));
}
#endif
...
inline PathNameType operator|(PathNameType a, PathNameType b) {
    return static_cast<PathNameType>(
        static_cast<uint32_t>(a) | static_cast<uint32_t>(b));
}
#endif
#ifndef DOSCONTROLCODE
#define DOSCONTROLCODE
...
inline DosControlCode operator|(DosControlCode a, DosControlCode b) {
    return static_cast<DosControlCode>(
        static_cast<uint32_t>(a) | static_cast<uint32_t>(b));
}
#endif
#ifndef VOLUMEINFO
...
#endif
#ifndef DISKFREESPACE
#define DISKFREESPACE
...
public:
    ...
    int64_t seek(int64_t offset, MoveMethod move_method = MoveMethod::Current);
...
public:
    ...
    std::string get_volume_path_names_for_volume_name(const char *volume_name);
    ...
    std::vector<WIN32_FIND_STREAM_DATA> ls_stream_data(const char *file_name);
    ...
    bool copy_all(const char *existing_path_name, const char *new_path_name);
