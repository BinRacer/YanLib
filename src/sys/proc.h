...
inline ProcCreateFlag operator|(ProcCreateFlag a, ProcCreateFlag b) {
    return static_cast<ProcCreateFlag>(
...
inline MemoryProtect operator|(MemoryProtect a, MemoryProtect b) {
    return static_cast<MemoryProtect>(
        static_cast<uint32_t>(a) | static_cast<uint32_t>(b));
}
#endif
#ifndef ALLOCATETYPE
...
public:
    ...
    PROCESS_INFORMATION create(const char *app_name,
    ...
    PROCESS_INFORMATION create(const wchar_t *app_name,
    ...
    PROCESS_INFORMATION create_with_suspended(const char *app_name,
        const char                                       *cmdline    = nullptr,
        SECURITY_ATTRIBUTES                              *proc_attrs = nullptr,
        SECURITY_ATTRIBUTES *thread_attrs                            = nullptr,
        bool                 is_inherit                              = false,
        ProcCreateFlag       create_flag = ProcCreateFlag::NormalPriorityClass |
                                     ProcCreateFlag::CreateSuspended,
        const char *curr_dir = nullptr);

    PROCESS_INFORMATION create_with_suspended(const wchar_t *app_name,
        wchar_t                                             *cmdline = nullptr,
        SECURITY_ATTRIBUTES *proc_attrs                              = nullptr,
        SECURITY_ATTRIBUTES *thread_attrs                            = nullptr,
        bool                 is_inherit                              = false,
    ...
    PROCESS_INFORMATION create_as_user(HANDLE token_handle,
        const char                           *app_name,
        const char                           *cmdline      = nullptr,
        SECURITY_ATTRIBUTES                  *proc_attrs   = nullptr,
        SECURITY_ATTRIBUTES                  *thread_attrs = nullptr,
    ...
    PROCESS_INFORMATION create_session_zero(const char *app_name,
        const char                                     *cmdline      = nullptr,
        SECURITY_ATTRIBUTES                            *proc_attrs   = nullptr,
        SECURITY_ATTRIBUTES                            *thread_attrs = nullptr,
        bool                                            is_inherit   = false,
    ...
    PROCESS_INFORMATION create_session_zero(const wchar_t *app_name,
        wchar_t                                           *cmdline    = nullptr,
        SECURITY_ATTRIBUTES                               *proc_attrs = nullptr,
        SECURITY_ATTRIBUTES *thread_attrs                             = nullptr,
        bool                 is_inherit                               = false,
    ...
    PROCESS_INFORMATION create_with_logon(const char *username,
        const char                                   *domain,
        const char                                   *password,
        const char                                   *app_name,
        const char                                   *cmdline = nullptr,
    ...
    PROCESS_INFORMATION create_with_logon(const wchar_t *username,
    ...
    PROCESS_INFORMATION create_with_token(HANDLE token_handle,
        const char                              *app_name,
        const char                              *cmdline = nullptr,
        LogonFlag      logon_flag  = LogonFlag::WithProfile,
        ProcCreateFlag create_flag = ProcCreateFlag::NormalPriorityClass |
    ...
    bool
    fake_proc(HANDLE proc_handle, const char *app_name, const char *cmdline);
    ...
    void *malloc(HANDLE proc_handle,
        size_t          size,
        void           *addr    = nullptr,
        AllocateType    type    = AllocateType::Commit | AllocateType::Reserve,
    ...
    bool
    write(HANDLE proc_handle, void *base_addr, const std::vector<uint8_t> &buf);
    ...
    bool set_env_var(const std::string &var_name, const std::string &var_value);
    ...
    bool set_affinity_mask(HANDLE proc_handle, DWORD_PTR proc_affinity_mask);
    ...
    bool set_priority_boost(HANDLE proc_handle, bool is_disable_priority_boost);
    ...
    bool get_processor_system_cycle_time(uint16_t group,
