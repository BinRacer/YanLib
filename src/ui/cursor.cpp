...
HCURSOR cursor::create(HINSTANCE instance_handle,
    ...
    HCURSOR result = CreateCursor(instance_handle, x_hotspot, y_hotspot, width,
        height, and_plane, xor_plane);
    if (!result) {
...
HCURSOR cursor::load(HINSTANCE instance_handle, const wchar_t *cursor_name) {
