...
namespace YanLib::ui::gdi {
    ...
    bool coordinate::set_window_org(HDC dc_handle, int32_t x, int32_t y, POINT *point) {
    ...
    bool coordinate::set_viewport_org(HDC dc_handle, int32_t x, int32_t y, POINT *point) {
    ...
    bool coordinate::scale_viewport(HDC dc_handle,
                                    ...
                                    int32_t y_div_factor, SIZE *size) {
