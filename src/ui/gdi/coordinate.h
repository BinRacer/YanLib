...
namespace YanLib::ui::gdi {
    ...
    public:
        ...
        static bool set_window_org(HDC dc_handle, int32_t x, int32_t y, POINT *point);
        ...
        static bool set_viewport_org(HDC dc_handle, int32_t x, int32_t y, POINT *point);
        ...
        static bool offset_window_org(HDC dc_handle, int32_t x, int32_t y, POINT *point);

        static bool offset_viewport_org(HDC dc_handle, int32_t x, int32_t y, POINT *point);
