...
namespace YanLib::ui::gdi {
    ...
    public:
        ...
        static int32_t display_config_get_device_info(
                DISPLAYCONFIG_DEVICE_INFO_HEADER* request_packet);

        static int32_t display_config_set_device_info(
                DISPLAYCONFIG_DEVICE_INFO_HEADER* request_packet);
        ...
        static int32_t
        get_display_config_buffer_sizes(uint32_t flag,
                                        uint32_t* num_path_array_elements,
                                        uint32_t* num_mode_info_array_elements);

        static int32_t get_display_config(uint32_t flag,
        ...
        static int32_t
        set_display_config(std::vector<DISPLAYCONFIG_PATH_INFO> &path_info,
                           std::vector<DISPLAYCONFIG_MODE_INFO> &mode_info,
                           uint32_t flag);

        static int32_t change_display_settings(DEVMODEA* device_mode,
                                               uint32_t flag);

        static int32_t change_display_settings(DEVMODEW* device_mode,
                                               uint32_t flag);

        static int32_t change_display_settings(const char* device_name,
                                               DEVMODEA* device_mode,
                                               HWND window_handle,
                                               uint32_t flag,
                                               void* lparam);

        static int32_t change_display_settings(const wchar_t* device_name,
                                               DEVMODEW* device_mode,
                                               HWND window_handle,
                                               uint32_t flag,
                                               void* lparam);
