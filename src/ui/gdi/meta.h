...
public:
    ...
    static bool play_enhance_meta_file_record(HDC dc_handle,
    ...
    static uint32_t get_enhance_meta_file_header(
        HENHMETAFILE   enh_meta_file_handle,
        uint32_t       size,
        ENHMETAHEADER *buf);

    static uint32_t get_enhance_meta_file_description(
        HENHMETAFILE enh_meta_file_handle,
    ...
    static uint32_t get_win_meta_file_bits(HENHMETAFILE enh_meta_file_handle,
        uint32_t                                        size,
        uint8_t                                        *buf,
        int32_t                                         map_mode,
        HDC                                             dc_handle);

    static HENHMETAFILE set_win_meta_file_bits(uint32_t size,
        const uint8_t                                  *buf,
        HDC                                             dc_handle,
        const METAFILEPICT                             *meta_file_pict);

    static uint32_t get_enhance_meta_file_bits(
        HENHMETAFILE enh_meta_file_handle,
        uint32_t     size,
        uint8_t     *buf);
    ...
    static bool gdi_comment(HDC dc_handle, uint32_t size, const uint8_t *buf);
};
} // namespace YanLib::ui::gdi
#endif // META_H
