...
namespace YanLib::ui::gdi {
    ...
    public:
        ...
        static uint32_t get_enhance_meta_file_header(HENHMETAFILE enh_meta_file_handle,
                                                         uint32_t size,
                                                         ENHMETAHEADER *buf);
        ...
        static uint32_t get_enhance_meta_file_bits(HENHMETAFILE enh_meta_file_handle,
                                                       uint32_t size,
                                                       uint8_t *buf);
