...
namespace YanLib::ui::gdi {
    int32_t
    rect::fill_rect(HDC dc_handle, const RECT* rect, HBRUSH brush_handle) {
        return FillRect(dc_handle, rect, brush_handle);
    }

    int32_t
    rect::frame_rect(HDC dc_handle, const RECT* rect, HBRUSH brush_handle) {
    ...
    bool
    rect::invalidate_rect(HWND window_handle, const RECT* rect, bool is_erase) {
    ...
    uint32_t
    rect::set_bounds_rect(HDC dc_handle, const RECT* rect, uint32_t flag) {
