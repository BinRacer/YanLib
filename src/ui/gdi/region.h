...
namespace YanLib::ui::gdi {
    ...
    public:
        ...
        static HRGN
        create_poly_polygon_region(const std::vector<POINT> &point,
        ...
        static int32_t get_update_region(HWND window_handle,
                                         HRGN region_handle,
                                         bool is_erase);

        static bool validate_region(HWND window_handle, HRGN region_handle);

        static bool invalidate_region(HWND window_handle,
                                      HRGN region_handle,
                                      bool is_erase);
