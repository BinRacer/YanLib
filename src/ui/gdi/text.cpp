...
namespace YanLib::ui::gdi {
    ...
    bool text::ext_text_out(HDC dc_handle,
                            ...
                            const std::string &text,
                            const int32_t* dx) {
        return ExtTextOutA(dc_handle, x, y, options, rect, text.data(),
                           text.size(), dx);
    }
    ...
    bool text::ext_text_out(HDC dc_handle,
                            ...
                            const std::wstring &text,
                            const int32_t* dx) {
        return ExtTextOutW(dc_handle, x, y, options, rect, text.data(),
                           text.size(), dx);
    }

    int32_t text::tabbed_text_out(HDC dc_handle,
                                  int32_t x,
                                  int32_t y,
                                  const std::string &text,
                                  int32_t tab_pos,
    ...
    int32_t text::draw_text(HDC dc_handle,
        ...
        return DrawTextA(dc_handle, text.data(),
                         static_cast<int32_t>(text.size()), rect, format);
    }
    ...
    bool
    text::set_text_justification(HDC dc_handle, int32_t extra, int32_t count) {
    ...
    uint32_t text::get_glyph_outline(HDC dc_handle,
                                     ...
                                     void* buf,
                                     const MAT2* mat2) {
        return GetGlyphOutlineW(dc_handle, ch, format, glyph_metrics, size, buf,
                                mat2);
    }
    ...
    int32_t text::get_text_face(HDC dc_handle, std::string &text) {
        return GetTextFaceA(dc_handle, static_cast<int32_t>(text.size()),
                            text.data());
    }

    int32_t text::get_text_face(HDC dc_handle, std::wstring &text) {
        return GetTextFaceW(dc_handle, static_cast<int32_t>(text.size()),
                            text.data());
    }
    ...
    uint32_t
    text::get_outline_text_metrics(HDC dc_handle,
                                   uint32_t size,
