...
public:
    ...
    static uint32_t
    get_kerning_pairs(HDC dc_handle, uint32_t pairs, KERNINGPAIR *kern_pair);
    ...
    static uint32_t get_outline_text_metrics(HDC dc_handle,
        uint32_t                                 size,
    ...
    static bool
    get_text_extent_point32(HDC dc_handle, const std::string &text, SIZE *size);
