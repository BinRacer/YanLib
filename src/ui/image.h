...
public:
    ...
    HBITMAP
    copy_bitmap(HBITMAP bitmap_handle, int32_t cx, int32_t cy, ImageFlag flag);

    HICON copy_icon(HICON icon_handle, int32_t cx, int32_t cy, ImageFlag flag);

    HCURSOR
    copy_cursor(HCURSOR cursor_handle, int32_t cx, int32_t cy, ImageFlag flag);
