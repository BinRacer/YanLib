...
inline MessageRemove operator|(MessageRemove a, MessageRemove b) {
    return static_cast<MessageRemove>(
...
inline SendTimeoutFlag operator|(SendTimeoutFlag a, SendTimeoutFlag b) {
    return static_cast<SendTimeoutFlag>(
        static_cast<uint32_t>(a) | static_cast<uint32_t>(b));
}
#endif
#ifndef SENDTYPE
...
inline BroadcastFlag operator|(BroadcastFlag a, BroadcastFlag b) {
    return static_cast<BroadcastFlag>(
        static_cast<uint32_t>(a) | static_cast<uint32_t>(b));
}
#endif
...
inline BroadcastResult operator|(BroadcastResult a, BroadcastResult b) {
    return static_cast<BroadcastResult>(
        static_cast<uint32_t>(a) | static_cast<uint32_t>(b));
}
#endif
#ifndef FILTERACTION
...
inline MessageBoxType operator|(MessageBoxType a, MessageBoxType b) {
    return static_cast<MessageBoxType>(
        static_cast<uint32_t>(a) | static_cast<uint32_t>(b));
}
#endif
...
public:
    ...
    bool get_current_input_source(INPUT_MESSAGE_SOURCE *input_message_source);
    ...
    long broadcast_system(uint32_t msg, /* RegularMessage */
        WPARAM                     wparam,
        LPARAM                     lparam,
