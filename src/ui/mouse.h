...
inline MouseEvent operator|(MouseEvent a, MouseEvent b) {
    return static_cast<MouseEvent>(static_cast<int>(a) | static_cast<int>(b));
}
#endif
#ifndef POINTERTYPE
#define POINTERTYPE
...
inline PointerFlag operator|(PointerFlag a, PointerFlag b) {
    return static_cast<PointerFlag>(
...
public:
    ...
    bool get_pointer_device_properties(HANDLE device_handle,
        uint32_t                             *real_num,
