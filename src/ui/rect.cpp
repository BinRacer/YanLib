...
namespace YanLib::ui {
    ...
    bool rect::set_rect(LPRECT rect,
                        int x_left,
                        int y_top,
                        int x_right,
                        int y_bottom) {
    ...
    bool rect::copy_rect(LPRECT rect_dst, const RECT *rect_src) {
    ...
    bool rect::inflate_rect(LPRECT rect, int x, int y) {
        return InflateRect(rect, x, y);
    }

    bool rect::intersect_rect(LPRECT rect_dst,
    ...
    bool rect::offset_rect(LPRECT rect, int x, int y) {
    ...
    bool rect::set_rect_empty(LPRECT rect) {
        return SetRectEmpty(rect);
    }

    bool rect::subtract_rect(LPRECT rect_dst,
                             const RECT *rect_src1,
                             const RECT *rect_src2) {
        return SubtractRect(rect_dst, rect_src1, rect_src2);
    }

    bool rect::union_rect(LPRECT rect_dst,
                          const RECT *rect_src1,
                          const RECT *rect_src2) {
