...
namespace YanLib::ui {
int32_t window_prop::enumerate(HWND window_handle, PROPENUMPROCA enum_func) {
    return EnumPropsA(window_handle, enum_func);
}

int32_t window_prop::enumerate(HWND window_handle, PROPENUMPROCW enum_func) {
    return EnumPropsW(window_handle, enum_func);
}

int32_t window_prop::enumerate(HWND window_handle,
