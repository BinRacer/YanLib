...
TEST_F(crypto_aes256, cbc_pkcs7) {
    ...
    EXPECT_EQ(encode_hex, "1dbf3d477f59e16aa5ba30f3e8161c6537e1cdef9e330aaeb38a"
...
TEST_F(crypto_aes256, ecb_pkcs7) {
    ...
    auto encode_hex = aes.hex_string();
    EXPECT_GT(encode.size(), 0);
    EXPECT_EQ(encode_hex, "8cff0eaea69ad07bb2f43c16b9c2b277b6750f7bbc2ef753212b"
...
TEST_F(crypto_aes256, cfb_pkcs7) {
    ...
    auto encode_hex = aes.hex_string();
    EXPECT_GT(encode.size(), 0);
    EXPECT_EQ(encode_hex, "126e195559516223803df1df43f5d6000de9d85b9386b72c48b1"
