...
TEST_F(crypto_aes, cbc_pkcs7) {
    ...
    EXPECT_EQ(encode_hex, "99bab35bf35923f01790a920042ab7f0888dee83a7de3d5652a5"
...
TEST_F(crypto_aes, ecb_pkcs7) {
    ...
    auto        encode_hex = aes.hex_string();
    EXPECT_GT(encode.size(), 0);
    EXPECT_EQ(encode_hex, "b74acf58c49c94565a3086580f8ea1b0f1d43a5dfefcb4cdb976"
...
TEST_F(crypto_aes, cfb_pkcs7) {
    ...
    auto encode_hex = aes.hex_string();
    EXPECT_GT(encode.size(), 0);
    EXPECT_EQ(encode_hex, "ddd1be0807ade6c73451a815fd81a40bf45add144aa2248b88ef"
