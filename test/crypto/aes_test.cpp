...
TEST_F(crypto_aes, cbc_pkcs7) {
    ...
    EXPECT_EQ(encode_hex,
              "99bab35bf35923f01790a920042ab7f0888dee83a7de3d5652a52e342c8ab51471f2c704f39eb4e13e2da84dd8f3bf9c");
...
TEST_F(crypto_aes, cbc_ansi_x923) {
    ...
    EXPECT_GT(encode.size(), 0);
    EXPECT_EQ(encode_hex,
              "99bab35bf35923f01790a920042ab7f0888dee83a7de3d5652a52e342c8ab51461f9a7d7b0b789bf82eaba0cd85a6f4a");
...
TEST_F(crypto_aes, ecb_pkcs7) {
    ...
    EXPECT_GT(encode.size(), 0);
    EXPECT_EQ(encode_hex,
              "b74acf58c49c94565a3086580f8ea1b0f1d43a5dfefcb4cdb9769144e06e6eebee4f4f499aa9aef5ee91d08ac4341f0e");
...
TEST_F(crypto_aes, ecb_ansi_x923) {
    ...
    EXPECT_GT(encode.size(), 0);
    EXPECT_EQ(encode_hex,
              "b74acf58c49c94565a3086580f8ea1b0f1d43a5dfefcb4cdb9769144e06e6eeb50da3d578dcb86111430010b48fd0d78");
...
TEST_F(crypto_aes, cfb_pkcs7) {
    ...
    EXPECT_GT(encode.size(), 0);
    EXPECT_EQ(encode_hex,
              "ddd1be0807ade6c73451a815fd81a40bf45add144aa2248b88ef3c78cfb1299e08d299c2697a152f7f17e4d5107666d5");
...
TEST_F(crypto_aes, cfb_ansi_x923) {
    ...
    EXPECT_GT(encode.size(), 0);
    EXPECT_EQ(encode_hex,
              "ddd1be0807ade6c73451a815fd81a40bf45add144aa2248b88ef3c78cfb1299e08d299c265f13f16fd26917de3e3fa1c");
