...
protected:
    void SetUp() override {
        ...
        ciphertext_str = "3baf349a1a5e420f2e10eb41d571427564b114fe175753f0abddae3148744472";
        ciphertext_vec.insert(ciphertext_vec.end(), ciphertext_str.begin(), ciphertext_str.end());
        ciphertext_vec = hex_decode(ciphertext_vec);
        zlib_str = "c2e88c4d1763b13a91ebaceb65d867c3d3b81befb225cbfa4698df9c0954c547";
