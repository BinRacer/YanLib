...
protected:
    void SetUp() override {
        ...
        ciphertext_str =
            "cb05378e92ced249fc1dfea151262af57c930f3dc04270f205a9d21be621fc083f"
            "24f1b8b687c1d2e5b8cd548cc67b26a803c760bc41223543bf0fa2866ee587";
        ciphertext_vec.insert(
            ciphertext_vec.end(), ciphertext_str.begin(), ciphertext_str.end());
        ciphertext_vec = hex_decode(ciphertext_vec);
        zlib_str =
            "3a91f218856d6a877b2b60837eeb8b9aa9dc3bb3fba70a190a0d3f5d08d1593e2e"
            "62d82a16860f32e6190d789bf1cd1dbb5ebdee0274afd33e6c5b5cc91ebec5";
