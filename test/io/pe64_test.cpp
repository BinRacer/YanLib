...
TEST_F(io_pe64, func_ordinals) {
    ...
    EXPECT_TRUE(pe64.set_export_func_ordinal(export_table_ptr.get(),
                                             func_ordinals));
...
TEST_F(io_pe64, func_ordinals_check) {
    ...
    EXPECT_TRUE(pe64.set_import_table_func_ordinal(first_thunk[0], thunk_data,
                                                   func_ordinals));
    func_ordinals[0] = func_ordinals_backup;
    EXPECT_TRUE(pe64.set_import_table_func_ordinal(first_thunk[0], thunk_data,
                                                   func_ordinals));
...
TEST_F(io_pe64, forwarder_chain_check) {
    ...
    EXPECT_TRUE(pe64.set_import_table_forwarder_chain(import_table,
                                                      forwarder_chains));
